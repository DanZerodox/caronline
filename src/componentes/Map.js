                                ...
                                : (
                                    <>
                                        <div className="form-group" style={{ marginTop: 60 }}>
                                            ...
                                            <input type="text" name="" className="form-control" onChange={this.handleChangeNoCasa} />
                                        </div>
                                        <div className="form-group">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="text" name="area" className="form-control" onChange={this.handleChangeReferencias} />
                                        </div>
                                    </>
                                )
                        }
