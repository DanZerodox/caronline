						...
						matches.small?(
							...
							<Card style={{boxShadow:'none', padding:'10px 90px', border:'none', backgroundColor:'#ffffff'}}>
								...
								<div style={{display:'flex', justifyContent:'space-between'}}>
									...
									<CardContent style={{textAlign:'center'}}><CardMedia style={useStyles} image={require('../images/Jumex/regalo.svg')}></CardMedia><p>VENTAJAS AL COMPRAR</p><p style={{lineHeight:0}}>EN LINEA</p></CardContent>
									<CardContent style={{textAlign:'center'}}><CardMedia style={useStyles} image={require('../images/Jumex/ayuda.svg')}></CardMedia><p>ASISTENTE VIRTUAL</p><p style={{lineHeight:0}}>LAS 24 HORAS</p></CardContent>
